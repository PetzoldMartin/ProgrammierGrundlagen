...
public class ThePalindromEnd {
	...
	public static BigInteger Prime = BigInteger.valueOf(2);
	public  BigInteger z3 = BigInteger.valueOf(0);
	...
	public ThePalindromEnd(BigInteger anfang, BigInteger schritt) {
		...
		for (BigInteger z2 = anfang; vergleich(z2); z2 = z2.add(schritt)) {
			z3 = z2.multiply(Prime);
			if (umdreh(z3) == true)
				;
			else if (umdreh(z3.pow(2)) == true)
				if ((groesser(quersumme(z3), Highscore))) {
					Highscore = quersumme(z3);
					zahl5=z3;
